...
public class ProductConverter implements Converter {
    ...
    public boolean canConvert(Class klasse) {return klasse.equals(Product.class);}

    public void marshal(Object wert, HierarchicalStreamWriter writer, MarshallingContext context) {
        Product product = (Product) wert;
