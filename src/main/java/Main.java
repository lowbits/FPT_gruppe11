...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //shop view und controller verlinken
        ...
        //customer übersicht erstellen und mit controller verlinken
        ViewCustomer view2 = new ViewCustomer();
        ControllerCustomer controller2 = new ControllerCustomer(); //wird noch nicht verwendet !
